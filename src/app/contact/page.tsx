            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="https://www.instagram.com/bmmparts.co.id" className="w-10 h-10 bg-gray-200 hover:bg-red-600 rounded-full flex items-center justify-center transition-colors group">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full bg-red-600 hover:bg-red-700 text-white py-4 rounded-lg font-semibold transition-colors duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                  >
