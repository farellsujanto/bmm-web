        ...
        <section className="bg-white rounded-lg shadow-md p-8 mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">Produk Asli</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">Pengiriman Cepat</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">Dukungan Ahli</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">Harga Kompetitif</h3>
